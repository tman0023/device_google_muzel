...
PRODUCT_PACKAGES += \
    ...
    DMServiceOverlayVendorBlazer \
    FrameworkResOverlayProductBlazer \
...
# Recovery
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/recovery/init.recovery.device.rc:$(TARGET_COPY_OUT_RECOVERY)/root/init.recovery.blazer.rc
